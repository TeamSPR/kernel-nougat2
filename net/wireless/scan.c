...
/*
 *  Tom Hite <tdhite@gmail.com>: From base Samsung Sources.
 */
#define IEEE80211_SCAN_RESULT_EXPIRE	(7 * HZ)
/*
 *  Tom Hite <tdhite@gmail.com>: Keep standard source def for reference.
 */
#ifndef IEEE80211_SCAN_RESULT_EXPIRE
